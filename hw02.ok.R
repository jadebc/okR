...
AutograderInit = function() {
  scores <<- vector(mode="character", length=4)   # Put total number of questions here
}
...
CheckProblem4 = function() {
  problemNumber = 4   # Change to question #
  eval = validate_that(is.numeric(w))
...
CheckProblem5 = function() {
  problemNumber = 5   # Change to question #
  eval = validate_that(is.character(name))
